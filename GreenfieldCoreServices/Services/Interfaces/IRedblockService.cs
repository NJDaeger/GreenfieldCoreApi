...
public interface IRedblockService
{
    ...
    Task<Result<Redblock>> CreateRedblock(string projectKey, int x, int y, int z, string message, long createdBy, string initialStatus, List<long> assignedUsers, List<string> assignedRoles);
    ...
    Task<Result> DeleteRedblock(string projectKey, long keyNumber, long deletedBy);
    ...
    Task<Result> UpdateRedblock(string projectKey, long keyNumber, string newMessage, long updatedBy);
    ...
    Task<Result<Redblock>> GetRedblockByKey(string projectKey, long keyNumber);

    /// <summary>
    /// Retrieves all redblocks within a project, optionally filtered by search criteria.
    /// </summary>
    /// <param name="projectKey">The key of the project to return redblocks from.</param>
    ...
    /// <returns></returns>
    Task<Result<RedblockSearchResult>> SearchRedblocks(string projectKey, RedblockSearchRequest searchFilter);
    ...
    Task<Result<RedblockStatus>> AddRedblockStatus(string projectKey, long keyNumber, string status, long createdBy);
    ...
    Task<Result<RedblockUserAssignment>> AddRedblockUserAssignment(string projectKey, long keyNumber, long assignedTo, long createdBy);
    ...
    Task<Result> RemoveRedblockUserAssignment(string projectKey, long keyNumber, long assignedTo);
    ...
    Task<Result<RedblockRoleAssignment>> AddRedblockRoleAssignment(string projectKey, long keyNumber, string roleName, long createdBy);
    ...
    /// <returns>A <see cref="Result"/> indicating whether the removal was successful.</returns>
    Task<Result> RemoveRedblockRoleAssignment(string projectKey, long keyNumber, string roleName);
    ...
    Task<Result<List<Guid>>> ReplaceRedblockEntities(string projectKey, long keyNumber, List<Guid> entities);
    ...
    Task<Result> ClearRedblockEntities(string projectKey, long keyNumber);
